{
  ...
  # created with `nix run github:nix-community/plasma-manager > default.nix`

  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-bf48dd8d-61b6-4f40-86dc-34cffb73315a = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2026,2,6,20,46,40.142";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities.bf48dd8d-61b6-4f40-86dc-34cffb73315a = "Default";
      kactivitymanagerdrc.main.currentActivity = "bf48dd8d-61b6-4f40-86dc-34cffb73315a";
      ...
      kdeglobals.Icons.Theme = "Nordic-darker";
      ...
      kwinrc.Desktops.Id_1 = "981d52cd-7a1f-46db-a895-e01f76b8bac1";
      ...
      kwinrc."Tiling/981d52cd-7a1f-46db-a895-e01f76b8bac1/0d5b73bf-ffa9-4039-ab7c-d2fedf675191".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc.Xwayland.Scale = 2;
      kwinrc."org.kde.kdecoration2".theme = "__aurorae__svg__Nordic";
      plasma-localerc.Formats.LANG = "en_US.UTF-8";
      plasmarc.Theme.name = "Nordic-Solid";
